<?php
/**
 * Template Name: Suburb Neighborhood Search Page
 *
...
<section id="suburb-neighborhoods" class="intro">
	<div class="gradient">
		<div class="container">
			<div class="row">
				<h1><?php the_title(); ?></h1>
			...
			<div class="site-wrap">
				...
				<?php
					$args2 = array(
						...
						'orderby'    => 'title',
						'order'      => 'ASC',
						'category_name'  => 'suburb+1',
					);
					$nregion = new WP_Query( $args2 );
					while ( $nregion->have_posts() ) : $nregion->the_post();
				?>
