...
<section id="how-we-work" class="intro">
	<div class="gradient">
		<div class="container">
			<div class="row">
				<h1><?php the_title(); ?></h1>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-7 col-sm-7">
								<div class="step-details">
									<div class="step-title">
										<h3><?php the_field( 'step_title_4') ?></h3>
									</div>
									<div class="step-description">
										<p><?php the_field( 'step_description_4') ?></p>
									</div>
								</div>
							</div>
							<div id="key-hang" class="col-md-5 col-sm-5">
								<div class="step-image">
									<img src="<?php the_field('image_step_4'); ?>" alt="step_four_image" />
								</div>
							</div>
						</div>
					</div>
...
<p> Watch us on YouTube <a href="https://www.youtube.com/watch?v=HUfNMhbYyWU">here</a></p>
<?php
	get_footer();
?>